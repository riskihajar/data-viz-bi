...
| Feature importance dan rekomendasi | Bagian 12 menunjukkan importance; bagian 13/16 memberi alasan dan rekomendasi. | Cukup | Mudah disalahartikan sebagai penyebab hasil akhir mata kuliah. | Tambahkan penjelasan tepat di bawah grafik: importance adalah asosiasi prediktif global; alasan per mahasiswa berasal dari rule layer dan interpretasi kausal memerlukan desain penelitian tersendiri. |
